    ...
    $.ajax({
        ...
        success: function (data) {
            $.each(data.rows, function (i, item) {
                ...
                tr += "<td><button class='btn btn-info btn-xs' href='javascript:;'  data-target='#addRootModal' onclick='edit(\"" + item.id + "\")'><i class='fa fa-edit'></i> 编辑 </button> <button class='btn btn-danger btn-xs' href='javascript:;' onclick='deleteSingle(\"" + item.id + "\")'><i class='fa fa-trash-o'></i> 删除 </button> </td>"
                tr += "</tr>";
                $("#tableBody").append(tr);
            })
